...
//   // Fetch items based on type and search
//   useEffect(() => {
...
//       try {
//         const endpoint = formData.itemType === "spare" ? "/spares" : "/tools";
...
//   const handleNext = () => {
//     if (step === 1 && !formData.selectedItem) {
//       toaster("error", "Please select an item");
//       return;
//     }
//     if (step === 1 && (!formData.quantity || formData.quantity <= 0)) {
...
//       const payload = {
//         spare_id:
//           formData.itemType === "spare" ? formData.selectedItem?.id : null,
//         tool_id:
//           formData.itemType === "tool" ? formData.selectedItem?.id : null,
...
//                   type="button"
//                   variant={
//                     formData.itemType === "spare" ? "default" : "outline"
//                   }
//                   onClick={() => {
//                     setFormData((prev) => ({
//                       ...prev,
...
//                 <Button
//                   type="button"
//                   variant={formData.itemType === "tool" ? "default" : "outline"}
//                   onClick={() => {
//                     setFormData((prev) => ({
//                       ...prev,
//                       itemType: "tool",
...
//                         {searchTerm
//                           ? "No items found"
//                           : `Type to search ${formData.itemType}s`}
//                       </div>
//                     ) : (
//                       items.map((item) => (
//                         <div
...
//                             formData.selectedItem?.id === item.id
...
//                             IN Part No: {item.indian_pattern}
//                           </div>
//                           <div className="text-xs text-gray-400">
//                             Category: {item.category} | Denos: {item.denos}
//                           </div>
//                         </div>
//                       ))
//                     )}
...
//                     <p className="font-medium text-green-800">Selected Item:</p>
//                     <p>
//                       <strong>Description:</strong>{" "}
//                       {formData.selectedItem.description}
//                     </p>
//                     <p>
//                       <strong>IN Part No:</strong>{" "}
//                       {formData.selectedItem.indian_pattern}
//                     </p>
//                     <p>
//                       <strong>Category:</strong>{" "}
//                       {formData.selectedItem.category}
//                     </p>
//                     <p>
//                       <strong>Denos:</strong> {formData.selectedItem.denos}
//                     </p>
//                   </div>
//                 )}

//                 <div>
//                   <Label className="mb-2 block">Quantity Demanded</Label>
//                   <Input
//                     type="number"
...
//               <Button
//                 onClick={handleNext}
//                 disabled={!formData.selectedItem || !formData.quantity}
//               >
//                 Next
//               </Button>
//             </div>
...
//               <p>
//                 <strong>Item:</strong> {formData.selectedItem?.description}
//               </p>
//               <p>
...
//                     }))
//                   }
//                   placeholder="MO Demand No. (Optional)"
//                 />
//               </div>
//               <div className="flex-1">
//                 <FormattedDatePicker
