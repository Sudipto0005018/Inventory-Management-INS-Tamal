            ...
            <>
                ...
                <Popover open={isPopoverOpen} onOpenChange={setIsPopoverOpen} modal={modalPopover}>
                    <div id={triggerDescriptionId} className="sr-only">
                        Multi-select dropdown. Use arrow keys to navigate, Enter to select, and
                        Escape to close.
                    </div>
                    ...
                    <PopoverTrigger asChild>
                        <Button
                            ...
                            className={cn(
                                "flex p-1 rounded-md border min-h-10 h-auto items-center hide-scrollbar justify-between bg-inherit hover:bg-inherit [&_svg]:pointer-events-auto",
