  ...
  return (
    <>
      <div className="px-2 w-full h-[calc(100vh-135px)] flex">
        ...
        <Dialog
          open={maintainConfirm.open}
          onOpenChange={(open) =>
            setMaintainConfirm((prev) => ({ ...prev, open }))
          }
        >
          <DialogContent onInteractOutside={(e) => e.preventDefault()}>
            <DialogTitle>Confirm Maintained Quantity</DialogTitle>
            ...
            <div className="flex justify-end gap-3 mt-4">
              ...
              {/* YES Button */}
              <Button onClick={() => handleFinalSubmit(true)}>Yes</Button>
            </div>
          </DialogContent>
        </Dialog>
      </div>
