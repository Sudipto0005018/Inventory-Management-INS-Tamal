...
const PermanentPendings = () => {
  ...
  const columns = useMemo(() => [
    ...
    { key: "voucher_no", header: "Survey Voucher No." },
    { key: "quantity", header: "Surveyed Qty" },
    //    { key: "status", header: "Status" },
    { key: "processed", header: "Proceed" },
  ]);
          ...
          <div>
              ...
              <>
                <div className="flex gap-4 w-full">
                  <div className="w-full">
                    <Label htmlFor="nac_no" className="ms-2 mb-2 mt-6">
                      Demand No.
                    </Label>
                    <Input
                      type="text"
            ...
            {inputs.issue_type == "stocking" && (
              <>
                <div className="flex gap-4 w-full">
                  <div className="w-full">
                    <Label htmlFor="mo_no" className="ms-2 mb-2 mt-6">
