...
//       status: originalRow.status === 1 ? "active" : "inactive",
//       password: "",
//       department: originalRow.departmentId,
//     });
...
//   rawRole: row.role, 
//   rawDepartment: row.departmentId, 
...
//       onToggle={async () => {
//         try {
//           const newStatus = row.status === 1 ? "inactive" : "active";

//           await apiService.post(`/users/update/${row.id}`, {
//             name: row.name,
