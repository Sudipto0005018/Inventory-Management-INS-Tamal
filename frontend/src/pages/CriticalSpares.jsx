...
const CriticalSpares = () => {
  ...
  const fetchdata = async (searchValue = inputs.search, page = currentPage) => {
    try {
      const response = await apiService.get("/spares/critical", {
        params: {
          page,
          search: searchValue,
          ...
          <div>
            ...
            <div className="flex flex-col mt-3">
              ...
              {/* <BoxNoInputs
                ...
                isLooseSpare={selectedRow.is_loose_spare} 
              /> */}
              ...
              {/* <BoxNoInputs
                ...
                isLooseSpare={Boolean(selectedRow.is_loose_spare)} 
                isAddRow={true} 
              /> */}
              <BoxNoInputs
      ...
      >
        ...
        >
          ...
          <div>
            ...
            {selectedIssue == "temporary" && <div>Temporary Issue</div>}
