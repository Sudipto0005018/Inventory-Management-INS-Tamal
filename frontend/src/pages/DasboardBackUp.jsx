...
//                 <TableCell key={idx + "" + idx2} className="py-4 text-center"></TableCell>
//             ))}
//         </TableRow>
//     ));
...
//                         <h4 className="w-full text-center font-bold text-black mb-2">TY Loan</h4>
...
//                     <div className="min-w-0 h-full bg-white rounded-md shadow-md p-2 flex flex-col overflow-hidden">
//                         <h4 className="w-full text-center font-bold text-black mb-2">NAC</h4>
//                         <div className="flex-1 w-full min-h-0">
//                             <ScrollArea className="h-full w-full rounded-md border">
//                                 <Table>
//                                     <TableHeader>
...
//                     <div className="min-w-0 h-full bg-white rounded-md shadow-md p-2 flex flex-col overflow-hidden">
//                         <h4 className="w-full text-center font-bold text-black mb-1">D787</h4>
//                         <div className="flex-1 w-full min-h-0">
//                             <ScrollArea className="h-full w-full rounded-md border">
//                                 <Table>
//                                     <TableHeader>
