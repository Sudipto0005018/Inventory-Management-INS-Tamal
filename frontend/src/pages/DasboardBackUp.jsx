...
export default function Dashboard() {
  ...
  return (
    <div className="p-6 bg-gray-50 min-h-screen">
      ...
      <div className="grid grid-cols-1 font-semibold md:grid-cols-2 xl:grid-cols-4 gap-4 mb-8">
        {/* Total Items */}
        <Card
          title="Total Items"
          value="14"
      ...
      <div className="grid grid-cols-1 font-semibold md:grid-cols-2 xl:grid-cols-4 gap-4">
        <Card
