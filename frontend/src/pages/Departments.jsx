...
const Departments = () => {
    ...
    const handleaddDepartment = async () => {
        try {
            const response = await apiService.post("/departments", { name: inputs.name });
            if (response.success) {
    ...
    return (
        <div className=" h-full">
            ...
            <Dialog
                ...
                onOpenChange={(set) => setIsOpen((prev) => ({ ...prev, addDepartment: set }))}
            >
                <DialogContent onPointerDownOutside={() => {}}>
                    ...
                    <DialogFooter>
                        <Button
                            onClick={() => setIsOpen((prev) => ({ ...prev, addDepartment: false }))}
                            variant="outline"
            ...
            <Dialog
                ...
                onOpenChange={(set) => setIsOpen((prev) => ({ ...prev, editDepartment: set }))}
            >
                <DialogContent onPointerDownOutside={() => {}}>
