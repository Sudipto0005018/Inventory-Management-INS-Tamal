...
const survey = [
  { header: "Issued To", key: "issue_to", width: 10 },
  { header: "Survey Qty", key: "survey_quantity", width: 15 },
  { header: "Withdrawal Qty", key: "withdrawl_qty", width: 20 },
...
const demand = [
  ...
  { header: "Survey Voucher No.", key: "survey_voucher_no", width: 20 },
  { header: "Surveyed Date", key: "survey_date", width: 20 },
  { header: "Created On", key: "created_at", width: 20 },
];

const issue = [
  { header: "Stocked In/ NAC Qty", key: "stocked_nac_qty", width: 30 },
  { header: "Quote Authority", key: "quote_authority", width: 20 },
  ...
  { header: "Requisition Date", key: "requisition_date", width: 10 },
  { header: "MO No.", key: "mo_no", width: 20 },
  { header: "MO Date", key: "mo_date", width: 20 },
  { header: "Demanded Qty", key: "demand_quantity", width: 15 },
  { header: "Returned Qty", key: "qty_received", width: 15 },
