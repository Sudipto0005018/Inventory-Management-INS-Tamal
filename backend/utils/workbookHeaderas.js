...
const procurement = [
  ...
  { header: "NAC / Ordered Qty", key: "nac_qty", width: 20 },
...
const stock_update = [
  ...
  { header: "Denmand Date", key: "demand_date", width: 20 },
  { header: "Demanded Qty", key: "demand_quantity", width: 15 },
  { header: "MO Issued Qty", key: "stocked_in_qty", width: 20 },
  { header: "MO Gate Pass No.", key: "mo_no", width: 20 },
  { header: "MO Issued Date", key: "mo_date", width: 20 },
  { header: "Received Qty", key: "qty_received", width: 15 },
  { header: "Status", key: "status", width: 20 },
  // { header: "Issue Date", key: "issue_date", width: 20 },
  // { header: "Box No.", key: "boxes", width: 20 },
...
const survey = [
  ...
  { header: "Surveyed Qty", key: "survey_quantity", width: 15 },
  { header: "Remarks", key: "remarks_survey", width: 20 },
];
...
const ty = [
  ...
  // { header: "Denos.", key: "denos", width: 20 },
  // { header: "Type", key: "type", width: 12 },
  { header: "Issued Qty", key: "qty_withdrawn", width: 15 },
  ...
  // { header: "Box No.", key: "boxes", width: 20 },
  // { header: "Item Distribution", key: "itemDistribution", width: 25 },
  { header: "Expected Return Date", key: "return_date", width: 20 },
  { header: "Qty Returned", key: "qty_received", width: 15 },
