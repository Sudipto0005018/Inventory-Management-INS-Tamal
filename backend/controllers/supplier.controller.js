...
async function addSupplier(req, res) {
    try {
        ...
        const query = "INSERT INTO supplier (name, address, contacts, details) VALUES (?, ?, ?, ?)";
        ...
        if (result.affectedRows === 0) {
            return res.status(400).json(new ApiErrorResponse(400, {}, "Failed to add supplier"));
        }
        res.status(201).json(new ApiResponse(201, {}, "Supplier added successfully"));
    } catch (error) {
...
async function getSupplierList(req, res) {
    try {
        ...
        res.status(200).json(new ApiResponse(200, rows, "Supplier List retrieved successfully"));
    } catch (error) {
...
async function updateSupplier(req, res) {
    try {
        ...
        if (result.affectedRows === 0) {
            return res.status(400).json(new ApiErrorResponse(400, {}, "Failed to update Supplier"));
        }
        res.status(200).json(new ApiResponse(200, {}, "Supplier updated successfully"));
    } catch (error) {
...
async function deleteSupplier(req, res) {
    try {
        ...
        if (result.affectedRows === 0) {
            return res.status(400).json(new ApiErrorResponse(400, {}, "Failed to delete supplier"));
        }
...
module.exports = { addSupplier, getSupplierList, getSuppliers, updateSupplier, deleteSupplier };
